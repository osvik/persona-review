  ...
  return [
    {
      ...
      text:
        ...
        `Explore the page as ${persona.name} would, using the persona's behaviours to decide what to scan, click, verify, or abandon, and using the motivations to judge what would make the cause credible and worth acting on. Each turn, call exactly one tool: scroll, click, type, or ${FEEDBACK_TOOL_NAME} when you're done. Take real actions rather than narrating hypothetical ones — if you would dismiss a banner that's blocking content, click it; if you would scroll to read more, scroll. Most personas reach a verdict in 2–6 actions.\n\n` +
        submissionBlock +
