...
`npm install` pulls the dependencies; `npm run build` compiles TypeScript to
`dist/` and marks the CLI executable; `npm run review -- --install-browsers`
downloads the browser for the local Playwright dependency.
